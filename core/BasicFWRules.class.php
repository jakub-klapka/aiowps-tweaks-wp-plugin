...
//		wp_enqueue_script( 'lumi_aiowps_tweaks_basicfw', plugin_dir_url( __DIR__ ) . 'src_js/basic_fw.js', array( 'jquery' ), $lumi_aiowps_tweaks['settings']['statics_version'], true );

		wp_enqueue_script( 'lumi_aiowps_tweaks_basicfw', plugin_dir_url( __DIR__ ) . 'assets/basic_fw.js', array( 'jquery' ), $lumi_aiowps_tweaks['settings']['statics_version'], true );
		...
		wp_localize_script( 'lumi_aiowps_tweaks_basicfw', 'LumiAIOWPSTweaksBasicFW', array(
			...
			'__dont_use_server_signature' => __( 'Don\'t use ServerSignature:', $lumi_aiowps_tweaks['settings']['textdomain'] ),
			'__server_signature_desc' => __( 'Use this option if your server don\'t allow for ServerSignature directive.', $lumi_aiowps_tweaks['settings']['textdomain'] ),
			'__dont_limit_upload_size' => __( 'Don\'t limit upload size:', $lumi_aiowps_tweaks['settings']['textdomain'] ),
			'__limit_upload_size_desc' => __( 'Use this option if you don\'t want to limit upload file size to 10MB.', $lumi_aiowps_tweaks['settings']['textdomain'] )
		) );
